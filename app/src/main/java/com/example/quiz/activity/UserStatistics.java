...
public class UserStatistics extends AppCompatActivity {
    ...
    Toolbar toolbar;
    TextView tvName, tvRank, tvScore, tvTotalQue, tvCorrect, tvInCorrect, tvCorrectP, tvInCorrectP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvName.setText(Session.getUserData(Session.NAME, UserStatistics.this));
