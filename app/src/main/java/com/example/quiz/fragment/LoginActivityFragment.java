...
import com.example.quiz.activity.LoginTabActivity;
import com.example.quiz.activity.MainActivity;
import com.example.quiz.activity.PrivacyPolicy;
...
public class LoginActivityFragment extends Fragment {
    ...
    RelativeLayout googleryt, mobileryt;
    CheckBox chkPrivacy;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        loginrlyt.setOnClickListener(view -> {
            if (chkPrivacy.isChecked()) {
                ...
                Toast.makeText(getActivity(), "Hãy tích vào chấp nhận Điều khoản dịch vụ!!", Toast.LENGTH_LONG).show();
            }
