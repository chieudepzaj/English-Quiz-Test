...
public class Constant {
    ...
    public static String JWT_KEY = "12345678";
    ...
    public static int PASSING_PER = 60;  //count level complete when user give >30 percent correct answer
    public static int giveOneCoin = 0;  //give  coin when user give 30 to 40 percent correct answer
    public static int giveTwoCoins = 0; //give  coins when user give 40 to 50 percent correct answer
    public static int giveThreeCoins = 0; //give  coin when user give 50 to 60 percent correct answer
    public static int giveFourCoins = 0;  //give  coin when user give > 60  percent correct answer
